...
of this README file can be found at http://chrisshattuck.com/blog/bible-field-drupal-module-readmetxt


### Introduction

The idea behind the Bible Field module is to provide a Druapl field that can
...
add a Drupal field for referencing the Hitchhiker's Guide to the Galaxy. Using
