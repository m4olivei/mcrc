    ...
    <div class="slide-image">
      ...
      <?php if (isset($node->field_slide_tagline['und'][0]['value'])): ?>
        <div class="slide-text">
          <div class="slide-tagline"><?php print render($content['field_slide_tagline']); ?></div>
          <?php if (isset($node->field_slide_link['und'][0]['url'])): ?>
            <?php print l($node->field_slide_link['und'][0]['title'], $node->field_slide_link['und'][0]['url'], array('attributes' => array('class' => array('btn-link')))); ?>
          <?php endif; ?>
        </div>
      <?php endif; ?>
    </div>
